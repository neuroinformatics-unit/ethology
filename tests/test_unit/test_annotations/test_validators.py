...
invalid_coco_file_sample_1_parametrization = [
    (
...
invalid_via_file_sample_1_parametrization = [
    (
...
def test_valid_via_coco_json_missing_keys(
    ...
    input_json_file_with_missing_keys = request.getfixturevalue(input_file)
