...
def check_ffmpeg_installed():
    ...
    if shutil.which("ffmpeg") is None:
        raise FFmpegNotFoundError("FFmpeg is not installed or not found in system PATH.")
    else:
        return True
...
def compress_video_h264(video_path:str, 
    ...
    Args:
        ...
        overwrite_output (bool, optional): Whether to overwrite an existing video on saveout_path.
    """
    ...
    try: 
        ...
        output.run(overwrite_output = overwrite_output, capture_stdout=True, capture_stderr=True)
